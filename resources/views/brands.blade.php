        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <a href="{{ url('/products?brand[]=' . $brand->id) }}" class="text-decoration-none">
                <div class="card h-100 border-0 rounded-4 brand-card position-relative overflow-hidden bg-white">
                    ...
                    <div class="card-body text-center pt-4 px-4 pb-4 mt-2 position-relative z-index-1">
                        <!-- Logo Inisial -->
                        ...
                        <div class="d-flex align-items-center justify-content-center text-pink fw-bold brand-link">
                            Jelajahi Produk <i class="fas fa-arrow-right ms-2 transition-icon"></i>
                        </div>
                    </div>
                </div>
            </a>
